...
# # Runserver IP and Port
# # Note: Change the port number as needed
...
# # Do not use this setting in production without proper security considerations
...
SECRET_KEY = 'django-insecure-85#7n0z21&%(g*b26=r(_s(!te94^5k_%f)yyiq_bt4@ud5(8*'
